...
% Font Settings
\usepackage{xeCJK}
\setCJKmainfont[Scale=0.85]{PingFang SC}
\setCJKmonofont[Scale=0.85]{PingFang SC}
...
\usepackage{bm}  % Bold math symbols in math mode (safe inside $...$)
\usepackage{bbm}  % For blackboard bold indicator functions like \mathbbm{1}
\usepackage{amsthm}
\usepackage{amsmath}
